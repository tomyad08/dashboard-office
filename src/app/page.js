      ...
      <div className="flex justify-center bg-white w-2/5 h-screen items-center">
        <div className="h-60">
          ...
          <input
            ...
            className="p-2 w-80 bg-green-100 rounded-lg my-2"
          />{" "}
          <br />
          ...
          <input
            ...
            className="p-2 w-80 bg-green-100 rounded-lg mb-2"
          />{" "}
          <br />
          <button
            className="p-2 w-80 text-center bg-green-800 text-white mt-10"
